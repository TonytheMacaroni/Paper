...
public class CraftDamageSourceBuilder implements DamageSource.Builder {
    ...
    private final PointeredMap damageContext;
    ...
    public CraftDamageSourceBuilder(DamageType damageType) {
        ...
        this.damageContext = new PointeredMap();
    }
    ...
    @Override
    public DamageSource.Builder withDamageContext(Consumer<PointeredMap> consumer) {
